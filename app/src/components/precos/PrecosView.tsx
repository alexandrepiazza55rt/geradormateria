  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-lg border border-slate-200 bg-white">
        <div className="hidden grid-cols-[1fr_70px_60px_120px_90px_60px_120px_75px_auto] gap-3 border-b border-slate-200 bg-slate-50 px-3 py-2 text-[11px] font-semibold uppercase tracking-wide text-slate-500 md:grid">
          <div>Descrição</div>
          <div>SAP</div>
          <div>Un BOM</div>
